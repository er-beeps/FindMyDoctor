...
<%@ page import="com.deerwalk.model.Gender" %>
<%--
...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="card  mx-auto mt-3 " style="width:70%;">
            ...
            <div class="card-body">
                <form role="form" action="/appointment" method="POST" name="formname" class="f1">
                    <input type="hidden" name="page" value="setAppointment">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <c:forEach items="${Gender.values()}" var="i">
                                <input type="radio" name="gender" value="${i}" id="gender" required="required" checked>${i}<br>
                            </c:forEach>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="address" type="text" name="address" maxlength="40" required>
                                </div>
                                <div class="col-md-6">
                                    Province:<select class="form-control" name="province" id="province" required>
                                ...
                                <div class="col-md-6">
                                    District:<select class="form-control" name="district" id="district" required>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="selecthealthinstitute" required>
                                <option selected disabled>--Select Healthinstitute--</option>
                                <c:forEach items="${healthinstitutelist}" var="healthinstitute">
                                    <option>${healthinstitute.name}</option>
                                </c:forEach>
                            </select>
                        </div>
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if (result.gender == 'Male'){
                    ...
                    $('#selectgender').find(':radio[name=gender][value="Others"]').prop('checked', true)
                }
